...
const X_HEADER = `<?xml version="1.0"?>\n<?mso-application progid="Excel.Sheet"?>
<Workbook\nxmlns="urn:schemas-microsoft-com:office:spreadsheet"\nxmlns:o="urn:schemas-microsoft-com:office:office"
xmlns:x="urn:schemas-microsoft-com:office:excel"\nxmlns:ss="urn:schemas-microsoft-com:office:spreadsheet"
xmlns:html="http://www.w3.org/TR/REC-html40">\n`;
const X_PROPS = `<DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
<Author>%author</Author>
<LastAuthor>%lastAuthor</LastAuthor>
<Company>%company</Company>
<Version>%version</Version>
</DocumentProperties>\n`;
const X_STYLES = `<Styles>
...
const X_CELL_END = '</Data></Cell>';
const DEFAULT_EXT = 'xls';
const X_ROW_START = '\n<Row>';
const X_ROW_END = '\n</Row>';
const DEFAULT_AUTHOR = 'Ricard Fíguls';
const DEFAULT_COMPANY = 'RFM Software (Ricard Figuls)';
...
class CountComponentPlugin {
    ...
    toExcel() {
        ...
        fs__default["default"].writeFileSync('filename.xls', content);
    }
    toLog() {
        ...
        Object.keys(this.total.components).forEach(key => {
            ...
            console.log(`\n${source.blue(key)} 组件引用次数 ${source.green(value)} 引用率 ${source.redBright(per)}%`);
        });
        console.log(`\n组件${source.blue('总共')}引用次数 ${source.green(this.total.len)}`);
    }
    apply(compiler) {
...
exports.CountComponentPlugin = CountComponentPlugin;
